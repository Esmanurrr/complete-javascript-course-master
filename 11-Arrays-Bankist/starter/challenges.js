...
// 6
const anyOkDog = dog => dog.curFood > (dog.recFood * 0.90) && dog.curFood < (dog.recFood * 1.10);
console.log(anyOkDog);

// 7
console.log(dogs.filter(anyOkDog));

// 8 
const copyDogs = [...dogs];
console.log(copyDogs.map(dog => dog.recFood).sort((a,b) => a - b));