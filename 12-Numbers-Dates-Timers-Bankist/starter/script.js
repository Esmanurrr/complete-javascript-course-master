...
const account1 = {
  ...
  movementsDates: [
    ...
    '2024-09-30T09:48:16.867Z',
    '2024-11-25T06:04:23.907Z',
    '2024-01-25T14:18:46.235Z',
    '2024-11-27T16:33:06.386Z',
...
// console.log(+'23'); // type conversion to number

// parsing
// console.log(Number.parseInt('30px', 10)); // 30 if radix argument will 2 then result is NaN
// console.log(Number.parseInt('e23', 10)); // NaN

// console.log(Number.parseInt('   2.5rem   ')); // 2 (no matter the white spaces)
// console.log(Number.parseFloat('   2.5rem  ')); // 2.5

// console.log(parseFloat('   2.5rem  ')); //traditional (not prefer)
...
// console.log(Number.isNaN(+'20X')); // false it is NaN
// console.log(Number.isNaN(20 / 0)); // false it is infinity
...
console.log(Math.max([5, 18, '23', 11, 2])); // 23 (type conversion)
console.log(Math.max([5, 18, '23px', 11, 2])); // NaN (can not do parsing)
...
console.log(Math.floor('23.3')); // type conversion 23
...
console.log(new Date('Dec 01 2024 12:18:54'));
console.log(new Date('December 27, 2000'));

console.log(new Date(account1.movementsDates[0]));

console.log(new Date(2037, 10, 19, 15, 23, 5)); //months are 0 based 10 -> november

console.log(new Date(2037, 10, 31, 15, 23, 5));

console.log(new Date(0));
console.log(new Date(3 * 24 * 60 * 60 * 1000)); // to convert a day
...
console.log(new Date(2142246185000));
